...
int spBars = 100; // must be greater than tpBars
int tpBars = 100;
      ...
      if((foundBarHighprice != 0.0) && (prevHigh != foundBarHighprice))
        {
         if(barType == "High")
           {
            if((prevHigh != 0.0) && (candels[index_highest].close > Bid) && (candels[index_lowest].close == prevLow) && (Bid == candels[index_lowest].close))
              {
         ...
         if(barType == "Low")
           {
            ...
            if((prevLow != 0.0) && (candels[index_lowest].close < Bid) && (candels[index_highest].close == prevHigh) && (Bid == candels[index_highest].close))
              {
