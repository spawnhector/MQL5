...
uint SocketOpen(SOCKET_CLIENT &socket,const string host,const ushort port)
  {
   ...
   return(socket_mql5_x64::SocketOpen(socket, host, port));
  }
//+------------------------------------------------------------------+
//|   SocketClose                                                    |
//+------------------------------------------------------------------+
...
uint SocketWriteStruct(SOCKET_CLIENT &socket,const string symbol,const MqlTick &tick)
  {
   ...
   return(socket_mql5_x64::SocketWriteStruct(socket,symbol,tick));
  }
//+------------------------------------------------------------------+
//|   SocketWriteString                                              |
//+------------------------------------------------------------------+
uint SocketWriteString(SOCKET_CLIENT &socket,const string str)
  {
   ...
   return(socket_mql5_x64::SocketWriteString(socket,str));
  }
//+------------------------------------------------------------------+
//|   SysErrorMessage                                                |
//+------------------------------------------------------------------+
...
input ushort         InpPort=8080;         // Port
